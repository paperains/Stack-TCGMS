...
if ( isset($_POST['submit']) ) {
    ...
    if ($delete == TRUE) { $success[] = "The card deck was successfully deleted."; }
...
if (empty($id)) {
    ...
    echo '<h1>Cards <span class="fas fa-angle-right" aria-hidden="true"></span> Delete a Card Deck?</h1>
    <center>';
    ...
    echo '</center>
    <form method="post" action="index.php?action=delete&page=cards&id='.$id.'">
    <input type="hidden" name="id" value="'.$id.'" />
    Are you sure you want to delete this card deck? <b>This action can not be undone!</b><br />Click on the button below to delete the card deck:<br />
