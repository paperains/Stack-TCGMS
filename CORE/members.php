...
if ($page == "join") {
  if ( $settings->getValue( 'tcg_registration' ) == "0") {
    ...
    <p>We regret to inform you that '.$tcgname.' is currently closed for registration. If you want to join us, kindly check on us constantly and wait for us to reopen the TCG for you! Thank you so much for your interest!</p>';
  } else {
    if ($stat == "sent") {
