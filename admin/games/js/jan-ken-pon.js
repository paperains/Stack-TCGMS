  ...
  with (document.game) {
    ...
    switch(choice) { // calculates score
      case 1 : // rock
        ...
        if (comp == 3) {  msg.value += 'You won!';   document.location="games.php?play=jan-ken-pon&go=won";   break; }
      case 2 : // paper
        if (comp == 1) {  msg.value += 'You won!';  document.location="games.php?play=jan-ken-pon&go=won";    break; }
      ...
      case 3 : // scissors
        ...
        if (comp == 2) {  msg.value += 'You won!'; document.location="games.php?play=jan-ken-pon&go=won";     break; }
